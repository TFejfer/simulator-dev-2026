...
/**
 * /var/www/training/pages/training-instructor-results.php
 *
...
$ctxKey = \App\Context\ctx_key($pageContext); // expected: training-instructor-results
...
require_once INSTALL_ROOT . 'App/Pages/Training/Instructor/ResultsPage.php';

$pageObj = new \App\Pages\Training\Instructor\ResultsPage();
