...
?>
<div id="btn_proceed" class="proceed-button proceed-button-<?php echo htmlspecialchars($status, ENT_QUOTES); ?>" data-location="<?php echo htmlspecialchars($location, ENT_QUOTES); ?>">
